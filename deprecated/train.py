...
if __name__ == '__main__':
    ...
    # Create the dataset
    dataset = img_transfer_AB(root=data_path,
                              transform_A=transform_c2,
                              transform_B=transform_c1,
                              )
    ...
    # test_set = img_tran_AB(root=data_path,
    #                        transform_A=transforms_A,
    #                        transform_B=transforms_B,
    #                        test=True
    #                        )
